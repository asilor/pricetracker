...
<div class="relative" use:emblaCarouselSvelte onemblaInit="{initCarrousel}">
    ...
    <button onclick={scrollPrev} class="absolute top-1/2 -left-5 bg-white rounded-full border p-3 shadow active:ring">
    ...
    <button onclick={scrollNext} class="absolute top-1/2 -right-5 bg-white rounded-full border p-3 shadow active:ring">
