<script>
  ...
  <form action="/search" method="GET" class="relative" onsubmit={handleSubmit}>
    <div class="relative overflow-hidden w-[400px] rounded-t-[19px] border" class:rounded-[19px]={hideResults} >
      <input
        type="text"
        placeholder="Search..."
        bind:value={query}
    ...
    <ul class="absolute bg-neutral-50 left-0 right-0 overflow-hidden border-t-0 border rounded-b-[19px] shadow-lg" class:hidden={hideResults}>
